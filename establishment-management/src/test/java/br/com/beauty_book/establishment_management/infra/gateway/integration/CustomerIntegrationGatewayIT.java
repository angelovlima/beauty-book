...
class CustomerIntegrationGatewayIT {
    ...
    static void setupMockClient() {
        ...
        System.setProperty(
                "spring.cloud.discovery.client.simple.instances.customer-management[0].uri",
    ...
    void shouldReturnCustomerWhenFound() throws Exception {
        long id = 1L;
        CustomerDto expected = new CustomerDto(id, "Carlos", "carlos@email.com");
