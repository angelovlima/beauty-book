...
class ProfessionalIntegrationGatewayIT {
    ...
    void shouldFindProfessionalById() throws Exception {
        long id = 1L;
        ProfessionalDto expected = new ProfessionalDto(id, "Mariana", "123.456.789-00", "11999999999", "mariana@email.com");
        ...
        Optional<Professional> result = gateway.findById(id);
